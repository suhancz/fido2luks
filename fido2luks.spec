...
install -Dm 644 dracut/96luks-2fa/keyscript.sh %{buildroot}/%{_prefix}/lib/dracut/modules.d/96luks-2fa/keyscript.sh
...
%attr(0775, root, root) "%{_prefix}/lib/dracut/modules.d/96luks-2fa/keyscript.sh"
